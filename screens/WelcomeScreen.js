...
// import { setLanguage } from "../i18n";  // Assuming you have a function to set language
...
//     await setLanguage(lang);  // This function saves the selected language in AsyncStorage
//     setLangState(lang);
//     Speech.speak(t("welcome_message"), { language: lang });  // Speak the welcome message in the selected language
//   };
